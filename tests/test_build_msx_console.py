...
class MsxConsoleBuildTests(unittest.TestCase):
    def test_memory_profile_is_fixed(self) -> None:
        ...
        self.assertEqual(STATE_END, 0x8322)
...
74c2   02e9   P  -          GRAPHIC  build/msx_graphics.rel
77ab   0180   P  -          STORAGE  build/msx_storage.rel
8000   0300   P  -          RAM.Z80  build/ram.rel
8300   0022   P  -          STATE.Z  build/msx_state.rel
"""
        self.assertEqual(
